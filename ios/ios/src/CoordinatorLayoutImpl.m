...
- (void)setIdWithNSString:(NSString *)id_ {
  if (id_ != nil && ![id_ isEqual:@""]) {
    ...
    [((ADXCoordinatorLayout *) nil_chk(coordinatorLayout_)) setIdWithInt:ASIdGenerator_getIdWithNSString_(id_)];
  }
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ASCoordinatorLayoutImpl_CoordinatorLayoutExt = { "CoordinatorLayoutExt", "com.ashera.coordinatorlayout", ptrTable, methods, fields, 7, 0x1, 25, 6, 3, -1, -1, -1, -1 };
